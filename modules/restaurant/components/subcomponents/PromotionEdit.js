    ...
    <ScrollView style={style.container}>
      <View style={{marginBottom: 56}}>
        ...
        />
        {
          ...
          onChangeText={value => setpromotion({...promotion, addItems: value})}
        />
          )
        }
        <View
          ...
          <DatePicker
            ...
            onDateChange={date =>
              setpromotion({
                ...promotion,
                from: new Date(`${date.split('/')[2]}-${date.split('/')[0]}-${date.split('/')[1]}`
                ),
              })
            }
          ...
          <DatePicker
            ...
            onDateChange={date =>
              setpromotion({
                ...promotion,
                expired: 
                  new Date(`${date.split('/')[2]}-${date.split('/')[0]}-${date.split('/')[1]}`
                )
              })
            }
            customStyles={{dateIcon: {display: 'none'}, dateInput: style.input}}
